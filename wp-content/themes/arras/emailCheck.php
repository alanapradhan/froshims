<?php
/*
 * Sends Registration Emails from wordpress to Newly Registered Captains
 */
...
$individualSport1=$_GET['individualSport1'];
$individualSport2=$_GET['individualSport2'];
/*
 * Team Sport Email
 * 
 */
 ...
 */
if($Iid !="0"){
$emailVar= mysql_query("SELECT * FROM beta_individual WHERE Iid='$Iid'");
$row= mysql_fetch_array($emailVar);
$firstname=$row["fname"];
$email=$row["email"];
$password=$row["password"];
