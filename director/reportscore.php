...
//Create Table
echo (" Team: .'$teamName'. Please check all the boxes that apply.");
...
//Create Table
echo (" Player: $teamName - Please check all the boxes that apply.");
print('<table cellpadding="5px" cellspacing="0" style="width:590px;" bgcolor="#FFFFFF" border="2" bordercolor="#782911"
align="center" >');
...
$team2Row= mysql_fetch_array($findTeam2);
print('<td>' . $team2Row["lname"] ." ". $team2Row["fname"] .'</td>');
