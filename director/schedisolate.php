...
?>  
  ...
  <div id="apDiv4">Full Schedule: <?
$now= date("m",time());
			
				 //Spring
				 if(7>now) {
				  $result = mysql_query("SELECT GameType FROM SpringGames Where GameType != '$GameType'");
				 
				 }
				 else {
				 $result = mysql_query("SELECT GameType FROM FallGames Where GameType != '$GameType'");
				 }
