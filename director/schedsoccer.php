...
$result = mysql_query("SELECT Game,Date,Time,Team1,Team2,Location,Winner,Forfeit  

FROM schedule WHERE Game= 'Soccer' ORDER by GID ASC");   
...
?>  
  ...
  <div id="apDiv4"><a href="schedule.php">Full Schedule</a> | Soccer | <a href="schedfrisbee.php">Frisbee</a> | Flag Football | Pingpong</div>
</body>
